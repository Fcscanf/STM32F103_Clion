//
// Created by fcant on 2025/12/12 星期五.
//
...
void tp_draw_touch_point(uint16_t x, uint16_t y, uint16_t color);    /* 画一个坐标校准点 */
void tp_adjust_info_show(uint16_t xy[5][2], double px, double py);   /* 显示校准信息 */

...
#ifndef STM32F103_CLION_NRF24L01_H
#define STM32F103_CLION_NRF24L01_H
...
#define NRF24L01_CE_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */

#define NRF24L01_CSN_GPIO_PORT             GPIOG
#define NRF24L01_CSN_GPIO_PIN              GPIO_PIN_7
#define NRF24L01_CSN_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PE口时钟使能 */

#define NRF24L01_IRQ_GPIO_PORT             GPIOG
#define NRF24L01_IRQ_GPIO_PIN              GPIO_PIN_6
#define NRF24L01_IRQ_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOG_CLK_ENABLE(); }while(0)   /* PG口时钟使能 */
...
#endif //STM32F103_CLION_NRF24L01_H